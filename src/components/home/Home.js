...
import bookishlogo from './bookishlogo.png'
...
class Home extends Component {
    render() {
        return (
            <React.Fragment>
                <img className="d-flex w-75" src={bookishlogo}></img>
                <h1 className="d-flex justify-content-center">Welcome Click a Link to Begin</h1>
